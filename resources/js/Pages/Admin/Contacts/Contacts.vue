                        ...
                        <div class="w-full overflow-x-auto shadow-md sm:rounded-lg">
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                ...
                                <tbody v-if="contacts.length != 0">
                                    <tr v-for="(contact, index) in contacts" :key="index"
                                        ...
                                        <td class="px-6 py-4 flex flex-row space-x-1">
                                            <PrimaryButton class="bg-red-700" @click="destroy(contact.id)">
                                                Delete
                                            </PrimaryButton>
                                        </td>
                                    </tr>
                                ...
                                <tfoot v-else>
                                    <tr>
                                        <td>
                                            <div class="text-red-700 font-bold text-2xl mx-4">No Contacts from clients at the moment</div>
                                        </td>
                                    </tr>
                                </tfoot>
                            </table>
...
function destroy(id) {
    if (confirm("Are you sure you want to Delete")) {
        form.get(route("admin.contacts.delete", id,{
            preserveScroll: true,
        }));
    }
}
