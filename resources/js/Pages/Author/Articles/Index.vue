<template>
  ...
  <div class="w-full">
  <table class="tableauto  text-left text-sm font-light bg-transparent">
    <thead class="border-b bg-neutral-800 font-medium text-white dark:border-neutral-500 dark:text-slate-400 dark:bg-black">
      <tr class="bg-gray-800 text-white hover:text-slate-400 dark:text-slate-400 px-4 md:px-8">
        ...
        <th scope="col" class="px-2 py-4" width="35%">Content</th>
        <th scope="col" class="px-2 py-4" width="5%">Published</th>
...
function destroy(id) {
    if (confirm("Are you sure you want to Delete")) {
        form.delete(route("author.articles.destroy", { id: id }),{
                preserveScroll: true,
            }
        );
    }
