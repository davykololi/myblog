                    ...
                    <div class="p-6 bg-white border-b border-gray-200 dark:bg-gray-700 dark:text-slate-400">
                      <div class="mb-12">
                        ...
                        <form @submit.prevent="submit">
                            <div>
                                <InputLabel for="name" value="Tag Name" class="dark:text-slate-400"/>
                            ...
                            <div>
                                <InputLabel for="description" value="Tag Description" class="dark:text-slate-400"/>
                            ...
                            <div>
                                <InputLabel for="keywords" value="Tag Keywords" class="dark:text-slate-400"/>
